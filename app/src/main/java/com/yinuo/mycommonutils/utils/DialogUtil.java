...
public class DialogUtil {
    ...
    public static void simpleSmartDialog(Context context, CharSequence msg,
        ...
        AlertDialog.Builder dialog = DialogFactory.buildSmartAlertDialog(context);
    ...
    public static void simpleConfirmDialog(Context context, CharSequence msg,
                                           final DialogInterface.OnClickListener listener) {
        simpleConfirmDialog(context, context.getString(R.string.simple_confirm_title), msg,
                listener);
    }
    ...
    public static void simpleConfirmDialog(Context context, String title, CharSequence msg,
        ...
        AlertDialog.Builder dialog = DialogFactory.buildAlertDialog(context);
    ...
    public static void simpleTipDialog(Context context, CharSequence msg,
        ...
        AlertDialog.Builder dialog = DialogFactory.buildAlertDialog(context);
        dialog.setPositiveButton(R.string.confirm, onClickListener);
        dialog.setTitle(context.getString(R.string.simple_confirm_title));
        dialog.setMessage(msg);
        dialog.setCancelable(false);
        dialog.create().show();
    }
    ...
    public static void singleChoiceDialog(Context context, String title, String[] items,
        ...
        AlertDialog.Builder dialog = DialogFactory.buildSinglechoiceAlertDialog(context);
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
    ...
    public static void multiChoiceDialog(Context context, String title, String[] items,
        ...
        AlertDialog.Builder dialog = DialogFactory.buildMultichoiceAlertDialog(context);
