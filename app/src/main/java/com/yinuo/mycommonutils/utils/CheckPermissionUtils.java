...
public class CheckPermissionUtils {
    ...
    public boolean onRequestAllPermissionResultNew(int requestCode, String[] permissions, int[] grantResults) {
        if (REQUEST_CODE_ASK_MULTIPLE_PERMISSIONS == requestCode) {
            ...
            tipMap.put(Manifest.permission.READ_PHONE_STATE, mActivity.getString(R.string.permission_tip_phone_state));
            tipMap.put(Manifest.permission.WRITE_EXTERNAL_STORAGE, mActivity.getString(R.string.permission_tip_write_storage));
            tipMap.put(Manifest.permission.ACCESS_COARSE_LOCATION, mActivity.getString(R.string.permission_tip_location));
            ...
            if (TextUtils.isEmpty(permisionTip)) {
                ...
                // Permission Denied
                String tipOri = mActivity.getString(R.string.permission_tip_title) + "\n" + permisionTip
                        + mActivity.getString(R.string.permission_tip_tail);
    ...
    private void requestSystemSettingPermission() {
        String tipOri = mActivity.getString(R.string.permission_tip_read_set);
